...
Get involved with Bootstrap development by [opening an issue]({{ .Params.repo }}/issues/new) or submitting a pull request. Read our [contributing guidelines]({{ .Params.repo }}/blob/v{{ .Params.current_version }}/.github/CONTRIBUTING.md) for information on how we develop.
