...
layout: docs
title: Popovers
description: Documentation and examples for adding Bootstrap popovers, like those found in iOS, to any element on your .Params.
group: components
toc: true
---
...
- Popovers require the [tooltip plugin]({{ .Site.BaseURL }}/docs/{{ .Params.docs_version }}/components/tooltips/) as a dependency.
