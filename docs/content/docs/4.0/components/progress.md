...
Bootstrap provides a handful of [utilities for setting width]({{ .Site.BaseURL }}/docs/{{ .Params.docs_version }}/utilities/sizing/). Depending on your needs, these may help with quickly configuring progress.
