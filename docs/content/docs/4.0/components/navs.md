...
Change the horizontal alignment of your nav with [flexbox utilities]({{ .Site.BaseURL }}/docs/{{ .Params.docs_version }}/layout/grid/#horizontal-alignment). By default, navs are left-aligned, but you can easily change them to center or right aligned.
...
If you need responsive nav variations, consider using a series of [flexbox utilities]({{ .Site.BaseURL }}/docs/{{ .Params.docs_version }}/utilities/flex/). While more verbose, these utilities offer greater customization across responsive breakpoints. In the example below, our nav will be stacked on the lowest breakpoint, then adapt to a horizontal layout that fills the available width starting from the small breakpoint.
...
Add dropdown menus with a little extra HTML and the [dropdowns JavaScript plugin]({{ .Site.BaseURL }}/docs/{{ .Params.docs_version }}/components/dropdowns/#usage).
...
If you're building our JavaScript from source, it [requires `util.js`]({{ .Site.BaseURL }}/docs/{{ .Params.docs_version }}/getting-started/javascript/#util).
