...
<table class="table table-bordered table-responsive">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="table-warning text-center align-middle">Only <a href="{{ .Site.BaseURL }}/docs/{{ .Params.docs_version }}/layout/grid/">grid</a> system</td>
      <td class="table-danger text-center align-middle">No</td>
      <td class="table-danger text-center align-middle">No</td>
      <td class="table-warning text-center align-middle">Only <a href="{{ .Site.BaseURL }}/docs/{{ .Params.docs_version }}/utilities/flex/">flex</a> utilities</td>
    </tr>
    <tr>
      <th scope="row">
      ...
      <td class="table-danger text-center align-middle">No</td>
      <td class="table-warning text-center align-middle">Only <a href="{{ .Site.BaseURL }}/docs/{{ .Params.docs_version }}/content/reboot/">Reboot</a></td>
      <td class="table-danger text-center align-middle">No</td>
      <td class="table-danger text-center align-middle">No</td>
    </tr>
  </tbody>
