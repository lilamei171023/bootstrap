...
[Install bootstrap]({{ .Site.BaseURL }}/docs/{{ .Params.docs_version }}/getting-started/download/#npm) as a Node.js module using npm.

## Importing JavaScript

Import [Bootstrap's JavaScript]({{ .Site.BaseURL }}/docs/{{ .Params.docs_version }}/getting-started/javascript/) by adding this line to your app's entry point (usually `index.js` or `app.js`):
...
First, create your own `_custom.scss` and use it to override the [built-in custom variables]({{ .Site.BaseURL }}/docs/{{ .Params.docs_version }}/getting-started/options/). Then, use your main sass file to import your custom variables, followed by Bootstrap:
{{< highlight sass >}}
@import "custom";
