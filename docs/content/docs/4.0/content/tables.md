...
Regular table background variants are not available with the dark table, however, you may use [text or background utilities]({{ .Site.BaseURL }}/docs/{{ .Params.docs_version }}/utilities/colors/) to achieve similar styles.
